...
const forecast = (latitide,longitude,callback)=>{
    ...
    request({url,json:true},(error,{ body }={})=>{
        ...
        if(error){
            ...
            callback(undefined,'The temperature of '+ body.location.region+','+body.location.country +'!!! is '+ body.current.temperature +' F , But feels like ' + body.current.feelslike +' F')
        }
    })
}
